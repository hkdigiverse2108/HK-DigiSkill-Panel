...
import 'package:hkdigiskill_admin/screens/workshop/testimonials/all_testimonials/table/table_source.dart';
import 'package:hkdigiskill_admin/utils/constants/image_strings.dart';
import 'package:hkdigiskill_admin/utils/constants/sizes.dart';

class WorkshopTestimonialsTable extends StatelessWidget {
  const WorkshopTestimonialsTable({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return AdminPaginatedDataTable(
        ...
        onPageChanged: (page) {},
        source: WorkshopTestimonialsDataSource(),
        columns: const [
          DataColumn2(label: Text('Image')),
          DataColumn2(label: Text('Name')),
          DataColumn2(label: Text('Workshop')),
