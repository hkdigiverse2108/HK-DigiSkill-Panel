...
import 'package:hkdigiskill_admin/screens/gallery/all_gallery/table/data_table.dart';
import 'package:hkdigiskill_admin/utils/constants/colors.dart';
import 'package:hkdigiskill_admin/utils/constants/sizes.dart';
import 'package:hkdigiskill_admin/utils/helpers/helpers.dart';

class GalleryDesktopScreen extends StatelessWidget {
  const GalleryDesktopScreen({super.key});
              ...
              child: Column(
                ...
                children: [
                  AdminTableHeader(
                    ...
                    onPressed: () => Get.toNamed(AdminRoutes.createGallery),
