...
class EditInstructorController extends GetxController {
  static EditInstructorController get instance => Get.find();
  ...
  void initFields(InstructorModel instructor) {
    image.value = instructor.image ?? "";
    nameController.text = instructor.name;
    designationController.text = instructor.designation ?? "";
    linkedinController.text = instructor.linkedin ?? "";
    instagramController.text = instructor.instagram ?? "";
    facebookController.text = instructor.facebook ?? "";
    twitterController.text = instructor.twitter ?? "";
  }
  ...
  Future<void> updateInstructor(InstructorModel instructor) async {
    try {
      ...
      final response = await api.post(
        path: ApiConstants.instructorUpdate,
