...
import 'package:hkdigiskill_admin/screens/course/curriculum/curriculums_list/table/data_table.dart';
import 'package:hkdigiskill_admin/utils/constants/colors.dart';
import 'package:hkdigiskill_admin/utils/constants/sizes.dart';
import 'package:hkdigiskill_admin/utils/helpers/helpers.dart';

class CourseCurriculumsDesktopScreen extends StatelessWidget {
  const CourseCurriculumsDesktopScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            AdminBreadcrumbWithHeading(
              heading: "Course Curriculums",
              breadcrumbsItems: ["Course Curriculums"],
            ),
              ...
              child: Column(
                ...
                children: [
                  AdminTableHeader(
                    ...
                    onPressed: () => Get.toNamed(AdminRoutes.cCreateCurriculum),
