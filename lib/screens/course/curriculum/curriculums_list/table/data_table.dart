...
import 'package:hkdigiskill_admin/screens/course/curriculum/curriculums_list/table/table_source.dart';
import 'package:hkdigiskill_admin/utils/constants/image_strings.dart';
import 'package:hkdigiskill_admin/utils/constants/sizes.dart';

class CourseCurriculumsTable extends StatelessWidget {
  const CourseCurriculumsTable({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return AdminPaginatedDataTable(
        ...
        onPageChanged: (page) {},
        source: CourseCurriculumsSource(),
        columns: [
