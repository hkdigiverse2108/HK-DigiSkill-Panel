...
import 'package:hkdigiskill_admin/screens/Course/curriculum/create_curriculum/widgets/resource_section.dart';
import 'package:hkdigiskill_admin/screens/Course/curriculum/create_curriculum/widgets/title_description.dart';
import 'package:hkdigiskill_admin/screens/Course/curriculum/create_curriculum/widgets/video_thumbnail_image.dart';
...
class CreateCourseCurriculumDesktop extends StatelessWidget {
  const CreateCourseCurriculumDesktop({super.key});
            ...
            Obx(
              () => Expanded(
                child: ElevatedButton(
                  onPressed: controller.isLoading.value
                      ? null
                      : controller.createCourseCurriculum,
                  child: controller.isLoading.value
                      ? const CircularProgressIndicator()
