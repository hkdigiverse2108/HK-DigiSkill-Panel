...
class EditLessonController extends GetxController {
  static EditLessonController get instance => Get.find();
  ...
  void initFields(CourseLessonModel lesson) {
    ...
    if (lesson.courseId != null) {
      ...
      selectedCourse.value = lesson.courseId!.name;
    } else {
      courseId.value = "";
      selectedCourse.value = "";
    }

    lessonLock.value = lesson.lessonLock;
  }
  ...
  Future<void> updateLesson(CourseLessonModel lesson) async {
    try {
      ...
      final response = await apiService.post(
        path: ApiConstants.courseLessonUpdate,
