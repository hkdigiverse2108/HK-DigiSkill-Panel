...
class AdminColors {
  // App theme colors
  static const Color primary = Color(0xFF03284F);
  static const Color secondary = Color(0xCC07519F);
  ...
  static Color darkContainer = AdminColors.white.withOpacity(0.1);

  // Button colors
  static const Color buttonPrimary = Color(0xFF03284F);
